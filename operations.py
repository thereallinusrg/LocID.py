'''
QTM LocID Operations 
Version Version 0.2.2 - 2023-11-22
...
def match_geom(SeT1, geoM1, SeT2, geoM2, SeT, diff_index):
    branches1, branches2 = compare_geom(
        SeT1, geoM1, SeT2, geoM2, SeT, diff_index)
...
def match(locid1, locid2):
    ...
    # TODO: Implement line matching
        ...
        raise ValueError(
            "Unsupported object type to match or bad encoded locids")
...
def change(locid1, locid2):
    ...
    # TODO: Implement line matching
        ...
        raise ValueError(
            "Unsupported object type to detect changes or bad encoded locids")
